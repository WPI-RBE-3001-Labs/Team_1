...
Final\ Lab.o: ../Final\ Lab.c
	...
	avr-gcc -I"C:\Users\djcupo\git\rbelib\RBELib\include" -Wall -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega644p -DF_CPU=18432000UL -MMD -MP -MF"Final Lab.d" -MT"Final\ Lab.d" -c -o "$@" "$<"
